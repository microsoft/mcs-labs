...
| Master Multi-Agent Architectures with Connected and Child Agents                                                 | [mcs-multi-agent](./labs/mcs-multi-agent)                           | Learn how to leverage multi-agent configurations in Microsoft Copilot Studio to build scalable, contextually-aware solutions. This lab teaches you when to use connected agents versus child agents, how to logically group tools and knowledge for optimal orchestration, and how to overcome limitations in tools and topics. You'll understand how to classify agent capabilities properly and avoid common pitfalls like overloading instructions or using the wrong agent type. |
