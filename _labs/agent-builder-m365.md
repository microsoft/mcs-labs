...
- Access to Microsoft 365 Copilot with the Researcher, Analyst, and Cowork (Frontier) frontier agents (for Use Cases #3 and #4)
...
- How could you combine Cowork (for agentic drafting — see the Cowork Hands-On lab) and Analyst (for financial modeling) to prepare a comprehensive investment recommendation — Analyst builds the NPV/IRR analysis, then Cowork drafts the executive email or memo presenting it?
